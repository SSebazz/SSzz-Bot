...
module.exports = async (client, interaction, args) => {
  ...
  const verifyFlags = {
    0: `Sin restricciones`,
    1: `Debe tener correo electrónico verificado en la cuenta`,
    2: `Debe estar registrado en Discord durante más de 5 minutos`,
    3: `Debe ser miembro del servidor durante más de 10 minutos`,
