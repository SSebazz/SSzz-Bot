    ...
    return Promise.all(promises)
        .then(async results => {
            ...
            client.embed({
               ...
               {
                    name: "ℹ️┆Information",
                    value: `¡Bot es un bot con el que puedes manejar todo tu servidor! Con no menos de 350+ comandos, tenemos un gran bot con muchas opciones para mejorar tu servidor!`,
                    inline: false,
                },
                {
                    name: "_____ \n\n│General",
                ...
                {
                    name: "🔗┆Links",
                    value: `Agrégame: [[HERE]](${client.config.discord.botInvite}) \nServidor de apoyo: [[HERE]](${client.config.discord.serverInvite})`,
                    inline: false,
                }],
                type: 'editreply'
            }, interaction)
