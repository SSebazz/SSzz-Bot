...
module.exports = async (client, interaction, args) => {
    ...
    if (code.includes('token') == true) return client.errNormal({ error: "No voy a enviar mi token!", type: 'editreply' }, interaction);
    ...
    try {
        ...
        if (outputResponse.length <= 1024) {
            ...
            const embed2 = new Discord.EmbedBuilder()
                .setTitle(`${interaction.user.tag} comando eval utilizado`)
                .addFields(
