        ...
        if (data) {
            ...
            async function endGame() {
                if (player.score === 21) {
                    ...
                    endMsg(
                        `Gana! Tienes 21!`,
                        `Bot tenía ${dealer.score.toString()}`,
                        `VERDE`
                    );
                }
                if (player.score > 21) {
                ...
                if (
                    ...
                    gameOver = true;
                    endMsg(
                        `Has ganado! Has derrotado a Bot!`,
                        `Bot tenía ${dealer.score.toString()}`,
                        `VERDE`
                    );
                }
                ...
                if (
                    ...
                    gameOver = true;
                    endMsg(`Empate!`, `Bot tenía ${dealer.score.toString()}`, `ROJO`);
                }
            }
            ...
            async function loop() {
                ...
                endMsg(
                    "Para golpear teclea `h`, para levantarte teclea `s`.",
                    `Buena suerte ;)`,
                    client.color
                );
            ...
            client.errNormal({ error: `No tienes ningún ${client.emotes.economy.coins}!`, type: 'editreply' }, interaction);
        }
    })
}