    ...
    await client.embed({
        ...
        fields: [
            {
                ...
                value: `Sólo tiene **${convertTime(60000)}** adivinar la respuesta!\n\n${opt}`
            }
        ],
        components: [row],
        type: 'editreply'
        ...
        collector.on('collect', async (trivia) => {
            ...
            if (trivia.customId === winningID) {
                ...
                await client.embed({
                    title: `🕹️・Trivia`,
                    desc: `GG, fue **${question.options[question.correct]}**. Ha dado la respuesta correcta en **${time}**.`,
                ...
                await client.embed({
                    title: `🕹️・Trivia`,
                    desc: `¡Mejor suerte la próxima vez! La respuesta correcta era **${question.options[question.correct]}**.`,
                    components: [{ type: 1, components: [fbtn1, fbtn2, fbtn3, fbtn4] }],
                    type: 'editreply'
                }, interaction)
            }
