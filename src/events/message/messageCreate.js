...
module.exports = async (client, message) => {
  ...
  if (
    ...
    client
      .embed(
        {
          title: "Hola, soy el Bot",
          desc: `Uso con comandos a través de Discord ${client.emotes.normal.slash} comandos`,
          fields: [
            {
              name: "📨┆Invítame",
              value: `Invitar Bot en tu propio servidor! [Click aquí](${client.config.discord.botInvite})`,
            },
            {
              name: "❓┇No veo ningún comando de barra oblicua",
              value:
                "Puede que el bot no tenga permisos para ello. Vuelva a abrir el enlace de invitación y seleccione su servidor. El bot obtendrá entonces los permisos correctos",
            },
            {
              name: "❓┆Necesita apoyo?",
              value: `Si tiene preguntas, puede unirse a nuestro [Servidor de asistencia](${client.config.discord.serverInvite})!`,
            },
            {
              name: "🐞┆Encontro un bug?",
              value: `Informe de todos los bugs a través de: \`/report bug\`!`,
            },
          ],
          components: [row],
        },
